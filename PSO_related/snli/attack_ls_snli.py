...
from PSO_related.all_shared.shared_parameters import EPSILON


# import tensorflow as tf

class LSAttack(object):
    ...
    def predict(self, sentence):
        ...
        tem = self.model.pred([self.premise], [sentence])[0]
    ...
    def local_search(self, x_adv, x_orig, candidates_by_wid, target):
        ...
        # local search greedy
        x_cur = x_adv.copy()
        x_cur = self._greedy_all(x_cur, x_orig, search_indices_set, candidates_by_wid, target)
