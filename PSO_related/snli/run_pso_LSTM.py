...
# ============= param ========================
TEST_SIZE = 2 # None: attack all examples. Postive Number: attack TEST_SIZE examples
SEED = 1212
pop_size = 60
max_iter = 20
...
model_name = 'BiLSTM'
tag = 'PSO'
SAVE_FOLDER = f'out/pso_related/multi_exp/{dataset_name}_{model_name}_{tag}/{SEED}'
