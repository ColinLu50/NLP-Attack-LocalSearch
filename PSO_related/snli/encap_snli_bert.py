...
from PSO_related.snli.SNLI_BERT import ModelTrainer
from PSO_related.snli.SNLI_BERT import adjustBatchInputLen
from PSO_related.snli import config

class Model(nn.Module):
    def __init__(self, inv_dict, model_path):
