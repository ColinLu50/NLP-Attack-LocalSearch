...
from PSO_related.sst2.SSTconfig import filenames, parameters
...
#     instance_name = "BERTModel_SST2"
#     logger.add(open(my_file.real_path_of("data/log/"+instance_name+".txt"), 'w', encoding='utf-8'), colorize=True,
#                format="{time} {level} {message}", backtrace=True, diagnose=True)
#
#     SST2_path = 'data/dataset/SST2_fortraining'
#
#     label2id = json.load(open(my_file.real_path_of(SST2_path, filenames.label2id), 'r', encoding='utf-8'))
#     random.seed(parameters.random_seed)
#     torch.manual_seed(parameters.random_seed)
#     torch.cuda.manual_seed(parameters.random_seed)
#     logger.info("Parameters:\n",str(parameters))
#     train_ids = json.load(open(my_file.real_path_of(SST2_path, filenames.train_set), 'r', encoding='utf-8'))
#     valid_ids = json.load(open(my_file.real_path_of(SST2_path, filenames.valid_set), 'r', encoding='utf-8'))
#     test_ids = json.load(open(my_file.real_path_of(SST2_path, filenames.test_set), 'r', encoding='utf-8'))
#     id2content = json.load(open(my_file.real_path_of(SST2_path, filenames.id2content), 'r', encoding='utf-8'))
#
...
#         t2 = time.time()
#         print(f'Epoch {i} Time: {t2 - t1:.2f}s')
#
#
