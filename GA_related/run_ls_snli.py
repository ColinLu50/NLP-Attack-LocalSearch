...
from GA_related.shared.attacks_LS import LSAttackSNIL
...
goog_lm = LM()
adversary = LSAttackSNIL(model, dist_mat, inv_vocab, goog_lm, n1=N, n2=K, use_suffix=False)
...
print()
print(f'SEED={SEED}, Test Size={TEST_SIZE}, S={S}, G={G}, N={N}, K={K}')
cur_logger.summary()
...
dataset_name = 'SNLI'
tag = 'all'
time_stag = datetime.now().strftime('%y%m%d_%H%M')
